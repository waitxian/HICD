...
def load_factor(file_path, pondering=None, keys_path=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--task", type=str, default='factor')
    ...
    if args.data_path:
        list_data_dict = load_factor(args.data_path)
    else:
    ...
    if args.pondering is not None:
        list_data_dict_keys = load_factor(args.data_path,pondering=args.pondering, keys_path=args.keys_path)
