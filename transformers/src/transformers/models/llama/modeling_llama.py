        ...
        **kwargs,
        ...
        if flag=='ave':
            if layer_head_mask is not None : 
                ...
                if attn_weights.shape[1] == self.num_heads and attn_weights.shape[2] > 1 and attn_weights.shape[3] == key_states.shape[2]:
                    layer_head_mask = layer_head_mask.to(attn_weights.device)
                    attn_weights = layer_head_mask.view(1, -1, 1, 1) * attn_weights.view(bsz, self.num_heads, q_len, src_len)
        ...
        if attn_weights.dtype != value_states.dtype:
