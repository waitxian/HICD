    ...
    def prepare_inputs_for_generation(
        ...
        **kwargs,
        ...
        if past_key_values is not None:
            ...
            if (
                inputs_embeds is not None  or (is_torchdynamo_compiling() or cache_position[-1] >= input_ids.shape[1])  
            ):
    ...
    def pondering_contrastive_greedy_decode(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            if ponder_input_ids is not None:
        ...
        if return_dict_in_generate:
            if self.config.is_encoder_decoder:
                ...
                aa= GreedySearchDecoderOnlyOutput(
                    sequences=input_ids,
                    scores=scores,
        ...
        **kwargs,
        ...
        if is_greedy_gen_mode and contrastive_decoding:
            ...
            beam_scorer = BeamSearchScorer(
                ...
                device=inputs_tensor.device,
                length_penalty=generation_config.length_penalty,
                do_early_stopping=generation_configc.early_stopping,
                num_beam_hyps_to_keep=generation_config.num_return_sequences,
                num_beam_groups=generation_config.num_beam_groups,
                max_length=generation_config.max_length,
            )
