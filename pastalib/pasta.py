...
from pastalib.utils import my_tokenizer_utils
#from pastalib.utils.my_tokenizer_utils import find_token_range
...
#注册的钩子函数
    def edit_multisection_attention(
        ...
        for token_range in token_ranges:
            for bi,(ti,tj) in token_range.tolist():#[[41, 46], [42, 46], [42, 48], [39, 43], [36, 44], [42, 46], [34, 39], [42, 44]]
                if self.scale_position == "include":
                    attention_mask[bi, head_idx, :, ti:tj] += scale_constant
