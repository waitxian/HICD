...
def load_race(data_path=None):
    if data_path:
        dataset = load_dataset(data_path,name="middle",trust_remote_code=True)
    else:
        dataset = load_dataset("ehovy/race", name="middle",trust_remote_code=True)
